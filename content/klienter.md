...
### [Bergen Student-TV](https://bstv.no)
...
### [Studentradioen i Bergen](https://srib.no)
...
### [Studentparlamentet ved UiB](https://spuib.no)
...
- [Valgomaten](https://valgomat.fribyte.no)
...
### [Bergen Open Source](https://boskonf.no)

Bergen Open Source, eller "boskonf" er en årlig teknologikonferanse i Bergen, som arrangeres av friByte. Konferansen er en møteplass for utviklere, studenter og andre som er interessert i teknologi.

Bergen Open Source har følgende tjenester hos oss:

- Nettside
- Skjema-side
- Fil-lagring

### [Root Linjeforening](https://rootlinjeforening.no)
